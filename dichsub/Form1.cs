...
namespace dichsub
{
    public partial class Form1 : Form
    {
        ...
        private async void Openchorme(ChromeDriver driver)
        {
            ...
            IWebElement element = wait1.Until(drv => drv.FindElement(By.XPath("//textarea[@placeholder='Ask anything...']")));
            int cn = 0;
            bool first = true;
            foreach (var item in groupedLines)
            {
                string sub = "";
                sub = "dich tiep cho toi";
                cnt++;
                if (cn > 0)
                {
                ...
                try
                {
                    ...
                    string srtFilePath = @"C:\Users\Administrator\Documents\Project\new\moi.srt";
